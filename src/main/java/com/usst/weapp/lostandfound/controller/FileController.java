...
import com.usst.weapp.lostandfound.utils.MD5Util;
...
//    }
    ...
    @ResponseBody
    public List<FileDO> listFilesByPage(@PathVariable int pageIndex, @PathVariable int pageSize) {
    ...
    public ResponseEntity<Object> serveFile(@RequestParam("id") String id) throws UnsupportedEncodingException {
        ...
        Optional<FileDO> file = fileService.getFileById(id);
    ...
    public String handleFileUpload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) {
        ...
        try {
            FileDO f = new FileDO(file.getOriginalFilename(), file.getContentType(), file.getSize(),
